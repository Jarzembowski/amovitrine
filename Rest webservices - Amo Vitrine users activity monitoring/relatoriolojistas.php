<?php
  session_start();
   ...
   $uri = "http://localhost/atividade/consulta/totallojistasinativos/";   
   $response = \Httpful\Request::get($uri)
   ->addHeader('Accept', 'application/json')
   ->send();

   
   $uri = "http://localhost/atividade/consulta/totalapplojistas/";
   $responseTotalApp = \Httpful\Request::get($uri)
   ->addHeader('Accept', 'application/json')
   ->send();
   
   $total_lojista_app = $responseTotalApp->body[0]->total_lojistas;   
   $total_inativo = $response->body[0]->qt_inativos; 
   $total_ativo = $total_lojista_app - $total_inativo;
   $pc_inativo = ceil($total_inativo * 100/$total_lojista_app);
   $pc_ativo = floor($total_ativo * 100/$total_lojista_app);
   
    /* Usuários inativos há mais de um mês */
   $uri = "http://localhost/atividade/consulta/totallojistainativoscritico/";   
      ...
      <div class="row" style="width: 96%;height: 85%;margin-left: auto;margin-right: auto; position: relative;top: 50%;transform: translateY(-50%);">
         <div class="col-lg-3 col-sm-3 col-xs-12" style="margin:0;padding:0;">
            <div class="row"  style="width: 100%;height:80%;margin:0;padding:0;min-width:300px">
               ...
               <div class="col-lg-12 col-sm-12 col-xs-12 texto-center nopadding" >
                  <font class="fonte-titulo">Lojistas</font>
               </div>               
               <div class="col-lg-12 col-sm-12 col-xs-12 nopadding texto-center" style="margin-bottom:20px;">        
                  <font class="fonte-total-label nopadding texto-center">(<?php echo $total_lojista_app; ?>)</font>
               </div>
               ...
               <div class="col-lg-12 col-sm-12 col-xs-12 texto-center" style="position:relative;">
                  ...
                  LOJISTAS QUE NÃO APRESENTAREM NENHUM TIPO DE ATIVIDADE NO APLICATIVO EM <B>QUINZE DIAS</B> SÃO CLASSIFICADOS COMO <B>INATIVO
         ...
         <div class="col-lg-9 col-sm-9 col-xs-12">
            ...
            <?php
              ...
              $uri = "http://localhost/atividade/consulta/getlistaLojista/";
              ...
              echo "<tr><td colspan='5'><input type='text' id='filter' class='form-control' placeholder='Pesquisar loja'></td></tr>";
              echo "<thead>";
              echo "<tr>";
              echo "<th>#</th>";
              ...
              foreach ($array as $key => $jsons) { 
                   ...
                   foreach($jsons as $key => $value) {        
                      if($value === "##0##"){
                        ...
                        echo "<td align='center'><div style='border-radius: 50%;width: 10px;height: 10px;background:black'></div></td>";  
                      }else{
                        echo "<td>".$value."</td>";  
                      }
