...
switch($view){
	...
	case "listaEmails":		
		$atividadeRestHandler = new AtividadeRestHandler();
		$atividadeRestHandler->getListaEmails();
		break;
	case "listaUsuariosAtivosEmails":		
		$atividadeRestHandler = new AtividadeRestHandler();
		$atividadeRestHandler->getUsuariosAtivosEmail();
		break;
	case "listaUsuariosInativosEmails":		
		$atividadeRestHandler = new AtividadeRestHandler();
		$atividadeRestHandler->getUsuariosInativosEmail();
		break;		
	case "listaLojista":		
		$atividadeRestHandler = new AtividadeRestHandler();
