...
class AtividadeRestHandler extends SimpleRest {
	...
	public function getListaEmails() {
		...
		$atividade = new Atividade();
		$rawData = $atividade->getListaEmails();
	...
	public function getUsuariosAtivosEmail() {
		...
		$atividade = new Atividade();
		$rawData = $atividade->getUsuariosAtivosEmail();
	...
	public function getUsuariosInativosEmail() {
		...
		$atividade = new Atividade();
		$rawData = $atividade->getUsuariosInativosEmail();
